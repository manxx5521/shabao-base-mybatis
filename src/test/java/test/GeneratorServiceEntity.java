...
public class GeneratorServiceEntity {
	...
	public void generateCode() {
		String packageName = "com.xiaoshabao.test";
		boolean serviceNameStartWithI = false;// user -> UserService, 设置成true: user -> IUserService
		generateByTables(serviceNameStartWithI, packageName, "td_m_user", "td_m_role");
	}
	...
	private void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        ...
        strategyConfig.setTablePrefix(new String[] { "td_m_", "td_" });// 此处可以修改为您的表前缀(注意小几率的放前边)
		...
		focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
			...
			public String outputFile(TableInfo tableInfo) {
				return "e:\\test/" + tableInfo.getEntityName() + ".xml";
			}
		});
